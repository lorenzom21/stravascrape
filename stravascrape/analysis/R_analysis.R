...
#Calories historgram
ggplot(data=data_df,aes(x=Calories)) +geom_histogram(binwidth=500,aes(fill=start_day))


#cadence histogram
ggplot(data = data_df[data_df$avg_cad>60,], aes(x=avg_cad)) + geom_histogram(binwidth=5) + ylab("test")
